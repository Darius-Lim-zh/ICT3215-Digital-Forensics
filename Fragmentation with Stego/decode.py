...
def display_usage():
    ...
    print("  <output_secret_file>    Path where the extracted secret file will be saved")
...
if __name__ == "__main__":
    ...
    # Unpack arguments
    pdf_file_path, output_dir = sys.argv[1:3]
    ...
    print("Decoded file path: " + out_code_path)
    decode_images_from_pdf(pdf_file_path, out_code_path)
